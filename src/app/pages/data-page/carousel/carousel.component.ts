...
import { selectApiData, selectApiSelectedDatum } from '../../../ngrx/selectors/api-data.selectors';
    ...
    if (!false)
      this.subscriptions.add(
        interval(1000)
          .pipe(
            map((_) => ({
              width: this.mainImageDiv ? this.mainImageDiv.nativeElement.clientWidth : 100,
              height: this.mainImageDiv ? this.mainImageDiv.nativeElement.clientHeight : 100,
            })),
