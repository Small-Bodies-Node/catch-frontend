...
export class PieChartComponent {
  ...
  colors: string[] = [
    'rgb(31 119 180)', 'rgb(174 199 232)', 'rgb(256 127 14)', 'rgb(256 187 120)',
    'rgb(44 160 44)', 'rgb(152 223 138)', 'rgb(214 39 40)', 'rgb(256 152 150)',
  ...
  getWedges() {
    ...
    return this.values.map((value, i) => {
      ...
      const wedge = {
        label: this.labelWedges ? value : undefined,
        start,
        arcLength,
