...
@Component({
  selector: 'app-desktop-view-1',
  templateUrl: './desktop-view-1.component.html',
  styleUrls: ['./desktop-view-1.component.scss'],
})
export class DesktopView1Component implements OnInit {
  // --->>>
